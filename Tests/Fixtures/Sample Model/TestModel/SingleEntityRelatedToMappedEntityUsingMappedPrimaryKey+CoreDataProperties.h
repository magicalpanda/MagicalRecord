//
//  SingleEntityRelatedToMappedEntityUsingMappedPrimaryKey+CoreDataProperties.h
//  MagicalRecord
//
...
@interface SingleEntityRelatedToMappedEntityUsingMappedPrimaryKey (CoreDataProperties)
