...
extern const struct SingleEntityRelatedToManyMappedEntitiesUsingMappedPrimaryKeyUserInfo {
	__unsafe_unretained NSString *distinctAttribute;
...
@property (nonatomic, readonly, strong) SingleEntityRelatedToManyMappedEntitiesUsingMappedPrimaryKeyID* objectID;
