...
- (void)testSaveActionDoesNotAssignEntitiesWithoutAContextToAContext
{
    ...
    [currentStack saveWithBlockAndWait:^(NSManagedObjectContext *localContext) {
        NSEntityDescription *entityDescription = [NSEntityDescription entityForName:[SingleEntityWithNoRelationships MR_internalEntityName] inManagedObjectContext:localContext];
