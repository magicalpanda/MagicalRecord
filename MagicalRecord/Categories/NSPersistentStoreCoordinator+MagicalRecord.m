...
+ (NSPersistentStoreCoordinator *) MR_coordinatorWithSqliteStoreAtURL:(NSURL *)storeURL options:(NSDictionary *)options
{
    return [self MR_coordinatorWithSqliteStoreAtURL:storeURL withOptions:options];
}
