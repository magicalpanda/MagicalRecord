...
{
    MRLogVerbose(@"Merging changes to %@context%@", [self isEqualTo:[[MagicalRecordStack defaultStack] context]] ? @"*** DEFAULT *** " : @"", ([NSThread isMainThread] ? @" *** on Main Thread ***" : @"Background Thread"));
