...
/**
 * @abstract Creates and returns a new NSManagedObject in the supplied NSManagedObject Context using the current entity description.
...
/**
 * @abstract Safely returns an attribute description for the given name, otherwise returns nil. In certain circumstances, the keys of the dictionary returned by `attributesByName` are not standard NSStrings and won't match using object subscripting or standard `objectForKey:` lookups.
 * @discussion There may be performance implications when using this method if your entity has a large number of attributes (greater than 100).
