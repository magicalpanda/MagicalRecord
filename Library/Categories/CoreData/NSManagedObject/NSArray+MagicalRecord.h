...
/**
 *  Enumerates an array of NSManagedObjects and retrieves them from the 
 *  specified context if possible. If it's not possible to retrieve any of the
 *  managed objects from the specified context, they will not be included in the
 *  result.
 *
...
/**
 *  Deletes any managed objects in the array instance from the specified 
 *  context.
 *
 *  @param context Managed object context
 */
