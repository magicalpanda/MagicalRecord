...
+ (instancetype) MR_findFirstWithPredicate:(NSPredicate *)searchterm sortedBy:(NSString *)property ascending:(BOOL)ascending offset:(NSUInteger)offset inContext:(NSManagedObjectContext *)context;
