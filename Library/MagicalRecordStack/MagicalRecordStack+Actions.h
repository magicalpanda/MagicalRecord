 ...
 *
 *  @param block Make changes to CoreData objects in this block using the passed in localContext. The block will not be performed on a background queue, and once complete, the context will be saved.
 *
